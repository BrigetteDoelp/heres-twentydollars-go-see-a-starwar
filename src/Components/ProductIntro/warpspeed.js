(function (root, factory) {
    ...
    function WarpSpeed(targetId,config){
        ...
        this.SPEED=config.speed===undefined||config.speed<0?2:config.speed;
        ...
        this.WARP_EFFECT_LENGTH=config.warpEffectLength===undefined?23:config.warpEffectLength<0?0:config.warpEffectLength;
